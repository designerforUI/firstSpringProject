...
public class TableActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.fonttable);
        ...
        bn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TableActivity.this, com.example.tlj.interfaceprogrammingforandroidapplications.MainActivity.class);
